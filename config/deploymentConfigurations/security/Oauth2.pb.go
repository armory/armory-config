...
type Oauth2 struct {
	...
	UserInfoMapping      *OauthuserInfoMapping `protobuf:"bytes,5,opt,name=userInfoMapping,proto3" json:"userInfoMapping,omitempty"`
	UserInfoRequirements *UserInfoRequirements `protobuf:"bytes,6,opt,name=userInfoRequirements,proto3" json:"userInfoRequirements,omitempty"`
}
...
func (x *Oauth2) GetResource() *Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *Oauth2) GetUserInfoMapping() *OauthuserInfoMapping {
	if x != nil {
...
func (x *Oauth2) GetUserInfoRequirements() *UserInfoRequirements {
	if x != nil {
...
type UserInfoRequirements struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Need to revisit this struct
	Kvpair []string `protobuf:"bytes,1,rep,name=kvpair,proto3" json:"kvpair,omitempty"`
}

func (x *UserInfoRequirements) Reset() {
	*x = UserInfoRequirements{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserInfoRequirements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserInfoRequirements) ProtoMessage() {}

func (x *UserInfoRequirements) ProtoReflect() protoreflect.Message {
	mi := &file_proto_deploymentConfigurations_security_Oauth2_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserInfoRequirements.ProtoReflect.Descriptor instead.
func (*UserInfoRequirements) Descriptor() ([]byte, []int) {
	return file_proto_deploymentConfigurations_security_Oauth2_proto_rawDescGZIP(), []int{2}
}

func (x *UserInfoRequirements) GetKvpair() []string {
	if x != nil {
		return x.Kvpair
	}
	return nil
...
func (*Resource) Descriptor() ([]byte, []int) {
	return file_proto_deploymentConfigurations_security_Oauth2_proto_rawDescGZIP(), []int{3}
}

func (x *Resource) GetUserInfoUri() string {
	if x != nil {
...
type OauthuserInfoMapping struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OauthuserInfoMapping) Reset() {
	*x = OauthuserInfoMapping{}
	if protoimpl.UnsafeEnabled {
...
func (x *OauthuserInfoMapping) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OauthuserInfoMapping) ProtoMessage() {}

func (x *OauthuserInfoMapping) ProtoReflect() protoreflect.Message {
	mi := &file_proto_deploymentConfigurations_security_Oauth2_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OauthuserInfoMapping.ProtoReflect.Descriptor instead.
func (*OauthuserInfoMapping) Descriptor() ([]byte, []int) {
	return file_proto_deploymentConfigurations_security_Oauth2_proto_rawDescGZIP(), []int{4}
}

func (x *OauthuserInfoMapping) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *OauthuserInfoMapping) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *OauthuserInfoMapping) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *OauthuserInfoMapping) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_proto_deploymentConfigurations_security_Oauth2_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x22, 0xd4, 0x02, 0x0a, 0x06, 0x4f, 0x61, 0x75, 0x74, 0x68,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x2a, 0x5a, 0x28, 0x63, 0x6f, 0x6e, 0x66, 0x69,
...
var file_proto_deploymentConfigurations_security_Oauth2_proto_goTypes = []interface{}{
	...
	(*UserInfoRequirements)(nil), // 2: proto.security.userInfoRequirements
	(*Resource)(nil),             // 3: proto.security.resource
	(*OauthuserInfoMapping)(nil), // 4: proto.security.OauthuserInfoMapping
}
var file_proto_deploymentConfigurations_security_Oauth2_proto_depIdxs = []int32{
	...
	3, // 1: proto.security.Oauth2.resource:type_name -> proto.security.resource
	4, // 2: proto.security.Oauth2.userInfoMapping:type_name -> proto.security.OauthuserInfoMapping
	2, // 3: proto.security.Oauth2.userInfoRequirements:type_name -> proto.security.userInfoRequirements
...
func file_proto_deploymentConfigurations_security_Oauth2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_deploymentConfigurations_security_Oauth2_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserInfoRequirements); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_deploymentConfigurations_security_Oauth2_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OauthuserInfoMapping); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
